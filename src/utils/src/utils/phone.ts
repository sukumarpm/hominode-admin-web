...
export function normalizePhone(
    ...
    // First treat the value as a normal local/national number.
    // This is important for Philippines numbers such as 09171234567.
    ...
    // Also tolerate pasted international digits without "+":
...
export function detectPhoneCountry(
    ...
    try {
        ...
        // Ignore incomplete numbers while typing.
    }
